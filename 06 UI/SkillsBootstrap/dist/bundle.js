...
var SkillsService = /** @class */ (function () {
    function SkillsService() {
        ...
        this.Skills = new rxjs_1.BehaviorSubject(this.arrSkills);
        this.client.getObservable("skills.json").subscribe(function (data) {
            _this.arrSkills = data;
            _this.Skills.next(_this.arrSkills);
        });
    }
    SkillsService.prototype.addSkill = function (s) {
...
var httpClient = /** @class */ (function () {
    ...
    httpClient.prototype.getObservable = function (url) {
...
Object.defineProperty(exports, "__esModule", { value: true });
var linqts_1 = __webpack_require__(/*! linqts */ "./node_modules/linqts/dist/linqts.es.js");
var SkillsService_1 = __webpack_require__(/*! ./SkillsService */ "./src/SkillsService.ts");
document.addEventListener("DOMContentLoaded", function (event) {
    var service = new SkillsService_1.SkillsService();
    //table
    service.Skills.subscribe(function (data) {
        var trs = "";
    ...
    //sum
    service.Skills.subscribe(function (data) {
        var netListOf = new linqts_1.List(data);
        document.getElementById("sSum").innerText =
            "Summe Ids: " + netListOf.Sum(function (el) { return el.id; }).toString();
    });
    document
        .querySelector("#btnAddSkill")
        .addEventListener("click", function (e) {
        service.addSkill({
            id: parseInt(document.querySelector("#txtID").value),
            name: document.querySelector("#txtSkill").value
        });
    });
});
...
module.exports = __webpack_require__(/*! G:\modernWebStack\06 UI\SkillsBootstrap\src\index.ts */"./src/index.ts");
